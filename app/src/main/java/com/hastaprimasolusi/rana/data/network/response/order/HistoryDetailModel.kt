...
data class HistoryDetailModel(
    ...
    var oRDERDETAIL: List<HistoryDetailProdModel>? = null,
    @SerializedName("ORDER_PROD_DETAIL")
    var oRDERPRODDETAIL: List<HistoryDetailProdModel>? = null,
    @SerializedName("ORDER_EXPIRED")
    var oRDEREXPIRED: String? = null,
    @SerializedName("ORDER_HISTORIES")
    var oRDERHISTORIES: List<HistoryDetailStatusModel>? = null,
    ...
    @SerializedName("ORDER_COURIER")
    var oRDERCOURIER: CourierModel? = null,

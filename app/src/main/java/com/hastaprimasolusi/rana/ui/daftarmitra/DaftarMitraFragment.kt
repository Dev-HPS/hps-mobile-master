 ...
 */
class DaftarMitraFragment: Fragment(), OnMapReadyCallback {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.fragment_daftar_mitra, container, false)
    }
...
//        })
        ...
        when(view?.id){
            ...
            R.id.btnDaftar -> {
                when {
                    ...
                    etEmail.text.isNullOrEmpty() -> etEmail.error = "Required"
                    ...
                    base64Image.isNullOrEmpty() -> showAlert(activity!!, "Foto Lokasi belum ditambahkan")
                    etLokasi.text.isNullOrEmpty() -> etLokasi.error = "Required"
                    etKodePos.text.isNullOrEmpty() -> etKodePos.error = "Required"
                    etNIK.text.isNullOrEmpty() -> etNIK.error = "Required"
                    !cbSetuju.isChecked -> {
                        showAlert(activity!!, "Anda belum menyetujui syarat dan ketentuan berlaku")
                    }
                    else -> {
                        actionRegister()
                    }
    ...
    private fun actionRegister(){
        ...
        request.nIK = etNIK.text.toString()
        viewModel.register(request){
            val dialog = Dialog(activity!!)
            dialog.setContentView(R.layout.dialog_cart_sukses)
            dialog.txtHeader.text = "Pendaftaran berhasil, silahkan tunggu konfirmasi dari kami"
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == 8 && resultCode == Activity.RESULT_OK) {
            ...
            GlobalScope.launch {
                ...
                base64Image = Base64.encodeToString(bytes, Base64.NO_WRAP or Base64.NO_PADDING)
